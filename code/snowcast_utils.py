...
# Replace 'DATE_VARIABLE_NAME' with the name of your environment variable
date_value = os.environ.get('SWE_FORECASTING_DATE')

if date_value:
    print(f"Date value from environment variable: {date_value}")
    test_start_date = date_value
else:
    print("Date variable not found in the environment.")
    test_start_date = get_operation_day()
    #raise ValueError("Cannot find target date from environment variable.")

# test_start_date = get_operation_day()
# test_start_date = "2024-07-18" # use this for debugging and generating SWE map for specific day
test_end_date = "2024-07-11"
#test_end_date = d1
